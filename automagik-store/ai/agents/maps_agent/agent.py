"""Google Maps Agent - Location services and attractions specialist."""
...
def get_maps_agent(
    ...
    **kwargs
    ...
    """
    Factory function to create a Google Maps agent.
    ...
    Returns:
        Configured Maps agent instance
    """
    # Load configuration
    ...
    return Agent(
        ...
        mcp_servers=config.get("mcp_servers", ["google-maps:*"]),
        user_id=user_id,
