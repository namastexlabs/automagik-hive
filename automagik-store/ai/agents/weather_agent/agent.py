"""Weather Agent - Weather forecast and climate specialist."""
...
def get_weather_agent(
    ...
    **kwargs
    ...
    """
    Factory function to create a weather forecast agent.
    ...
    Returns:
        Configured weather agent instance
    """
    # Load configuration
    ...
    for tool_config in config.get("tools", []):
        if tool_config["name"] == "DuckDuckGoTools":
            tools.append(DuckDuckGoTools(
                cache_results=tool_config.get("cache_results", False)  # Fresh weather data
            ))
