...
async def get_code_development_team(
    ...
    team = await create_team("code-development-team", session_id=session_id, user_id=user_id, debug_mode=debug_mode)
    ...
    team.metadata.update({
        ...
        "specialization": ["project_onboarding", "code_analysis", "file_operations", "code_modifications"]
    })
