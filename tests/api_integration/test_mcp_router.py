...
class TestMCPStatus:
    ...
    def test_get_mcp_status_empty_servers(self, test_client, api_headers, mock_mcp_catalog):
...
class TestMCPServerListing:
    ...
    def test_list_available_servers_success(self, test_client, api_headers, mock_mcp_catalog):
    ...
    def test_list_available_servers_with_errors(self, test_client, api_headers, mock_mcp_catalog):
    ...
    def test_list_available_servers_empty(self, test_client, api_headers, mock_mcp_catalog):
...
class TestMCPServerTesting:
    ...
    def test_test_server_connection_success(self, test_client, api_headers, mock_mcp_tools):
    ...
    def test_test_server_connection_special_chars(self, test_client, api_headers, mock_mcp_tools):
...
class TestMCPConfiguration:
    ...
    def test_get_mcp_configuration_success(self, test_client, api_headers, mock_mcp_catalog):
    ...
    def test_get_mcp_configuration_with_errors(self, test_client, api_headers, mock_mcp_catalog):
    ...
    def test_get_mcp_configuration_empty(self, test_client, api_headers, mock_mcp_catalog):
...
class TestMCPRouterEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_mcp_endpoints_async(self, async_client: AsyncClient, api_headers, mock_mcp_catalog):
    ...
    def test_mcp_endpoints_concurrent_requests(self, test_client, api_headers, mock_mcp_catalog):
    ...
    def test_mcp_endpoints_response_consistency(self, test_client, api_headers, mock_mcp_catalog):
    ...
    def test_mcp_endpoints_large_server_list(self, test_client, api_headers, mock_mcp_catalog):
