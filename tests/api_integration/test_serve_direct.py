...
class TestServeModuleImports:
    ...
    def test_environment_loading(self):
        ...
        with patch("api.serve.load_dotenv") as mock_load_dotenv:
            import api.serve
...
class TestServeConfiguration:
    ...
    def test_log_level_configuration(self):
        ...
        with patch.dict(os.environ, {'HIVE_LOG_LEVEL': 'DEBUG', 'AGNO_LOG_LEVEL': 'INFO'}):
            with patch("api.serve.logger") as mock_logger:
                import api.serve
                import importlib
                importlib.reload(api.serve)
    ...
    def test_default_log_levels(self):
        ...
        env_without_logs = {k: v for k, v in os.environ.items() 
