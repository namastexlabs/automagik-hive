...
class TestActualMessageValidation:
    ...
    def test_validate_message_dependency_success(self):
        ...
        async def test_validation():
            result = await validate_message_dependency("Valid test message")
            return result
    ...
    def test_validate_optional_message_dependency_valid(self):
        ...
        async def test_validation():
            result = await validate_optional_message_dependency("Valid message")
            return result
    ...
    async def test_validate_runs_request_json(self):
        ...
        mock_request.body.return_value = json.dumps({"message": "Test message"}).encode()
    ...
    async def test_validate_runs_request_form_data(self):
        ...
        mock_request = Mock()
        mock_request.headers = {"content-type": "multipart/form-data; boundary=something"}
        mock_form = Mock()
