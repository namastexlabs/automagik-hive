...
class TestApiSettings:
    ...
    @patch.dict(os.environ, {"HIVE_ENVIRONMENT": "production", "HIVE_CORS_ORIGINS": "https://example.com"})
    ...
    def test_production_missing_cors_origins_error(self):
        ...
        try:
            ...
            with pytest.raises(ValidationError, match="HIVE_CORS_ORIGINS must be set in production"):
                ApiSettings()
        finally:
