...
class TestEmojiLoaderComprehensive:
    ...
    def test_emoji_loader_config_loading_success(self, temp_directory, mock_emoji_config):
        ...
        with patch.object(EmojiLoader, '_get_config_path', return_value=str(config_file)):
            loader = EmojiLoader()
            loader._load_config()
    ...
    def test_emoji_loader_config_file_not_found(self):
        ...
        with patch.object(EmojiLoader, '_get_config_path', return_value="/non/existent/path.yaml"):
            loader = EmojiLoader()
            loader._load_config()
    ...
    def test_emoji_loader_invalid_yaml(self):
        ...
        with patch("builtins.open", mock_open(read_data=invalid_yaml)):
            with patch.object(EmojiLoader, '_get_config_path', return_value="/fake/path.yaml"):
                loader = EmojiLoader()
                loader._load_config()
    ...
    def test_auto_emoji_function_with_config(self, mock_emoji_config):
        ...
        with patch.object(EmojiLoader, '_load_config') as mock_load:
    ...
    def test_emoji_loader_pattern_matching(self, mock_emoji_config):
        ...
        with patch.object(EmojiLoader, '_config', mock_emoji_config):
            ...
            for message, file_path, expected_context in test_cases:
                ...
                if expected_context:
                    patterns = mock_emoji_config["context_patterns"].get(expected_context, [])
    ...
    def test_emoji_loader_file_permissions_error(self):
        ...
        with patch("builtins.open", side_effect=PermissionError("Permission denied")):
            with patch.object(EmojiLoader, '_get_config_path', return_value="/restricted/path.yaml"):
                loader = EmojiLoader()
                loader._load_config()
...
class TestEmojiLoaderIntegration:
    ...
    def test_emoji_loader_memory_usage(self):
        ...
        from lib.utils.emoji_loader import get_emoji_loader, auto_emoji
