...
from lib.utils.yaml_cache import (
    YAMLCacheManager, get_yaml_cache_manager, reset_yaml_cache_manager,
    load_yaml_cached, discover_components_cached
)
from lib.utils.emoji_loader import get_emoji_loader, auto_emoji, get_path_emoji, get_keyword_emoji
...
class TestEmojiLoader:
    ...
    def test_emoji_loader_has_emoji(self):
        ...
        assert loader.has_emoji(text_with_emoji) == True
        
        # Test text without emoji
        text_without_emoji = "Plain text"
        assert loader.has_emoji(text_without_emoji) == False
