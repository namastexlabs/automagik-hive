...
class TestBaseValidatedRequest:
    ...
    def test_base_model_config(self):
        ...
        from lib.validation.models import BaseValidatedRequest
        
        # Test configuration attributes
        config = BaseValidatedRequest.Config
...
class TestAgentRequest:
    ...
    def test_agent_request_message_sanitization(self):
        ...
        assert "alert(xss) world" in request.message
        
        # Test quote removal
        request = AgentRequest(message='Hello "world" and \'test\'')
        assert '"' not in request.message
        assert "'" not in request.message
        assert "Hello world and test" == request.message
...
class TestTeamRequest:
    ...
    def test_team_request_valid_creation(self):
        ...
        from lib.validation.models import TeamRequest
    ...
    def test_team_request_task_sanitization(self):
        ...
        assert '"' not in request.task
        assert "'" not in request.task
        assert "Task with quotes and apostrophes" == request.task
...
class TestWorkflowRequest:
    ...
    def test_workflow_request_valid_creation(self):
        ...
        from lib.validation.models import WorkflowRequest
...
class TestHealthRequest:
    ...
    def test_health_request_creation(self):
        ...
        from lib.validation.models import HealthRequest
        ...
        assert hasattr(request, '__config__')
...
class TestVersionRequest:
    ...
    def test_version_request_creation(self):
        ...
        from lib.validation.models import VersionRequest
...
class TestErrorResponse:
    ...
    def test_error_response_creation(self):
        ...
        from lib.validation.models import ErrorResponse
...
class TestSuccessResponse:
    ...
    def test_success_response_creation(self):
        ...
        from lib.validation.models import SuccessResponse
...
class TestValidationModelsIntegration:
    ...
    def test_field_descriptions(self):
        ...
        from lib.validation.models import AgentRequest, TeamRequest, WorkflowRequest
        
        # Test AgentRequest field descriptions
        agent_fields = AgentRequest.__fields__
        assert "description" in agent_fields["message"].field_info.extra
        assert "Message to send to the agent" == agent_fields["message"].field_info.extra["description"]
        
        # Test TeamRequest field descriptions
        team_fields = TeamRequest.__fields__
        assert "description" in team_fields["task"].field_info.extra
        assert "Task description for the team" == team_fields["task"].field_info.extra["description"]
        
        # Test WorkflowRequest field descriptions
        workflow_fields = WorkflowRequest.__fields__
        assert "description" in workflow_fields["workflow_id"].field_info.extra
        assert "Workflow identifier" == workflow_fields["workflow_id"].field_info.extra["description"]
    ...
    def test_model_serialization(self):
        ...
        from lib.validation.models import AgentRequest, ErrorResponse, SuccessResponse
        ...
        success_data = success_response.dict()
...
class TestValidationEdgeCases:
    ...
    def test_dangerous_key_variations(self):
        ...
        from lib.validation.models import AgentRequest, WorkflowRequest
