...
class TestDatabaseService:
    ...
    def test_database_service_initialization_from_env(self):
        ...
        with patch.dict(os.environ, {'HIVE_DATABASE_URL': 'postgresql://env:env@localhost:5432/env_db'}):
    ...
    @pytest.mark.asyncio
    async def test_database_service_initialize_idempotent(self, mock_psycopg_operations):
    ...
    @pytest.mark.asyncio
    async def test_database_service_get_connection_initializes_pool(self, mock_psycopg_operations):
    ...
    async def test_database_service_fetch_one(self, mock_database_pool):
        ...
        mock_database_pool['cursor'].fetchone.return_value = expected_result
    ...
    async def test_database_service_fetch_one_no_result(self, mock_database_pool):
        ...
        # Mock no result
        mock_database_pool['cursor'].fetchone.return_value = None
    ...
    async def test_database_service_fetch_all(self, mock_database_pool):
        ...
        mock_database_pool['cursor'].fetchall.return_value = expected_results
    ...
    async def test_database_service_fetch_all_empty_result(self, mock_database_pool):
        ...
        # Mock empty result
        mock_database_pool['cursor'].fetchall.return_value = []
...
class TestDatabaseServiceEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_database_service_query_methods_with_none_params(self, mock_database_pool):
