...
class TestGetMCPTools:
    ...
    @patch('lib.mcp.connection_manager.get_catalog')
    @patch('lib.mcp.connection_manager.MCPTools')
    async def test_command_server_connection(self, mock_mcp_tools_class, mock_get_catalog):
    ...
    @patch('lib.mcp.connection_manager.get_catalog')
    @patch('lib.mcp.connection_manager.MCPTools')
    async def test_command_server_without_args(self, mock_mcp_tools_class, mock_get_catalog):
    ...
    async def test_unknown_server_type(self, mock_get_catalog):
        ...
        with pytest.raises(MCPConnectionError, match="Unknown server type for unknown-server"):
    ...
    async def test_mcp_tools_creation_failure(self, mock_logger, mock_mcp_tools_class, mock_get_catalog):
        ...
        with pytest.raises(MCPConnectionError, match="Failed to connect to failing-server"):
    ...
    @patch('lib.mcp.connection_manager.get_catalog')
    @patch('lib.mcp.connection_manager.MCPTools')
    async def test_sse_server_with_empty_env(self, mock_mcp_tools_class, mock_get_catalog):
...
class TestCreateMCPToolsSync:
    ...
    def test_sync_unknown_server_type(self, mock_get_catalog):
        ...
        with pytest.raises(MCPConnectionError, match="Unknown server type for unknown-sync"):
            create_mcp_tools_sync("unknown-sync")
    
    @patch('lib.mcp.connection_manager.get_catalog')
    @patch('lib.mcp.connection_manager.MCPTools')
    @patch('lib.mcp.connection_manager.logger')
    def test_sync_mcp_tools_creation_failure(self, mock_logger, mock_mcp_tools_class, mock_get_catalog):
        ...
        with pytest.raises(MCPConnectionError, match="Failed to connect to failing-sync"):
    ...
    @patch('lib.mcp.connection_manager.get_catalog')
    @patch('lib.mcp.connection_manager.MCPTools')
    def test_sync_command_server_empty_env(self, mock_mcp_tools_class, mock_get_catalog):
