...
class TestMCPServerConfig:
    ...
    def test_is_command_server_property(self):
        ...
        command_with_attr = MCPServerConfig(name="cmd-server", type="other", command="python")
...
class TestMCPCatalog:
    ...
    def test_has_server(self):
        ...
        config_data = {
            "mcpServers": {
                "existing-server": {"type": "command", "command": "test"}
            }
        }
    ...
    def test_reload_catalog(self):
        ...
        initial_config = {
            "mcpServers": {
                "initial-server": {"type": "command", "command": "initial"}
            }
        }
    ...
    def test_catalog_repr_representation(self):
        ...
        config_data = {"mcpServers": {"test-server": {"type": "command", "command": "test"}}}
