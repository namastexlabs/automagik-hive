...
class TestTriggerConversationTypificationWorkflow:
    ...
    def test_successful_typification_with_protocol(self, mock_is_registered, mock_get_workflow):
    ...
    @patch('ai.workflows.registry.get_workflow')
    @patch('ai.workflows.registry.is_workflow_registered')
    def test_typification_without_protocol_id(self, mock_is_registered, mock_get_workflow):
    ...
    @patch('ai.workflows.registry.get_workflow')
    @patch('ai.workflows.registry.is_workflow_registered')
    def test_typification_result_without_metadata_attribute(self, mock_is_registered, mock_get_workflow):
...
class TestSendFarewellMessage:
    ...
    def test_logging_calls(self, mock_logger):
        ...
        assert any('Farewell message created successfully' in call for call in log_calls)
