...
class TestWorkflowDiscovery:
    ...
    def test_discover_workflows_missing_config(self, mock_path):
        ...
        mock_workflow_dir.__truediv__.side_effect = lambda x: mock_config_file if x == "config.yaml" else mock_workflow_file
    ...
    def test_discover_workflows_import_exception(self, mock_path, mock_importlib):
        ...
        # Mock import failure
        mock_importlib.spec_from_file_location.side_effect = ImportError("Failed to import")
