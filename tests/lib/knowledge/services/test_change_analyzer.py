...
class TestChangeAnalyzer:
        ...
        self.config = {
            "knowledge": {
                "csv_reader": {
                    ...
                    "metadata_columns": ["question", "category", "tags"]
                }
            }
        }
    ...
    def test_analyze_changes_basic(self):
        ...
        mock_connection.execute.side_effect = [
            mock_result1, mock_result2,  # For row existence checks
    ...
    def test_analyze_changes_new_rows(self):
        ...
        csv_rows = [
            {
                "index": 0,
                "hash": "new_hash1", 
                "data": {"question": "New question 1", "answer": "New answer 1"}
            },
            {
                "index": 1,
                "hash": "new_hash2",
                "data": {"question": "New question 2", "answer": "New answer 2"}
            }
        ]
        ...
        mock_connection.execute.side_effect = [
            mock_result, mock_result,  # Row existence checks
        ...
        csv_rows = [
            {
                "index": 0,
                "hash": "changed_hash1",
                "data": {"question": "Question 1", "answer": "Updated answer 1"}
            }
        ]
    ...
    def test_analyze_changes_orphaned_rows(self):
        ...
        mock_connection.execute.side_effect = [
            mock_result,  # Row existence check
            mock_ids_result,  # Database IDs query
            mock_content_result1, mock_content_result2, mock_content_result3  # Content queries
        ]
    ...
    def test_analyze_changes_mixed_scenario(self):
        ...
        mock_connection.execute.side_effect = [
            mock_result1, mock_result2, mock_result3,  # Row existence checks
            mock_ids_result,  # Database IDs query
            mock_content_results[0], mock_content_results[1], 
            mock_content_results[2], mock_content_results[3]  # Content queries
        ]
    ...
    def test_config_column_usage(self):
        ...
        custom_config = {
            "knowledge": {
                "csv_reader": {
                    "content_column": "response",
                    "metadata_columns": ["inquiry", "topic"]
                }
            }
        }
