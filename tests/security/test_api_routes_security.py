...
class TestHealthEndpointSecurity:
    ...
    def test_health_endpoint_information_disclosure(self, client):
        ...
        sensitive_keywords = [
            ...
            "connection", "user", "internal", "config", "env"
        ]
...
class TestMCPRouterSecurity:
    ...
    def test_mcp_status_endpoint_error_handling(self, mock_catalog_class, client):
        ...
        mock_catalog_class.side_effect = Exception("Internal MCP error with sensitive data: password123")
        ...
        for endpoint in endpoints:
            for params in malicious_params:
                with patch('api.routes.mcp_router.MCPCatalog') as mock_catalog_class:
                    ...
                    assert response.status_code in [200, 400, 422]  # OK, Bad Request, or Validation Error
...
class TestVersionRouterSecurity:
    ...
    @pytest.fixture
    def test_app(self):
        """Create test app with version router."""
        app = FastAPI()
    ...
    def test_version_endpoints_authentication_requirements(self, client):
        ...
        for endpoint, method in protected_endpoints:
            ...
            assert response.status_code in [401, 422, 404]  # Unauthorized, Validation Error, or Not Found
    ...
    def test_version_execution_input_validation(self, client):
        ...
        for payload in malicious_payloads:
            ...
            assert response.status_code in [400, 401, 422, 404]  # Bad Request, Unauthorized, Validation Error, or Not Found
    ...
    def test_version_creation_authorization(self, client):
        ...
        for config in dangerous_configs:
            ...
            assert response.status_code in [401, 403, 422, 404]  # Unauthorized, Forbidden, Validation Error, or Not Found
    ...
    def test_version_history_information_disclosure(self, client):
        ...
        with patch('api.routes.version_router.AgnoVersionService') as mock_service_class:
...
class TestV1RouterSecurity:
    ...
    def test_v1_router_large_request_handling(self, client):
        ...
        assert response.status_code in [400, 413, 422, 401, 404]  # Bad Request, Payload Too Large, Validation Error, Unauthorized, or Not Found
    ...
    def test_v1_router_security_headers(self, client):
        ...
        version_patterns = ["fastapi", "uvicorn", "python"]
...
class TestAPISecurityIntegration:
    ...
    @pytest.fixture
    def full_app(self):
        """Create full FastAPI app with all routes."""
        app = FastAPI()
        app.include_router(v1_router)
        return app
    ...
    def test_api_error_handling_consistency(self, client):
        ...
        error_tests = [
            ...
            ("/api/v1/version/execute", "GET", 405),  # Method not allowed  
        ]
