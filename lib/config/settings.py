...
class Settings:
    ...
    def __init__(self):
        ...
        if langwatch_explicit is not None:
            ...
            self.enable_langwatch = langwatch_explicit.lower() in ("true", "yes", "1", "on", "enabled")
        else:
        ...
        self.langwatch_config = {k: v for k, v in self.langwatch_config.items() if v is not None}
