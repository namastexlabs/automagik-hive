...
class MCPToolConfig(BaseModel):
    ...
    tool_name: Optional[str] = Field(None, description="Specific tool name (if different from server)")
...
class AgentConfig(BaseModel):
    ...
    # Instructions
    instructions: Union[str, List[str]] = Field(..., description="Agent instructions")
    
    # Tools (mixed regular and MCP tools)
    tools: List[str] = Field(default_factory=list, description="List of tools including MCP tools")
    
    # Knowledge filtering
    knowledge_filter: Optional[Dict[str, Any]] = Field(None, description="Knowledge base filtering")
...
class TeamConfig(BaseModel):
    ...
    # Instructions
    instructions: Union[str, List[str]] = Field(..., description="Team instructions")
