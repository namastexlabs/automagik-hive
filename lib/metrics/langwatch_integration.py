...
class LangWatchManager:
    ...
    def initialize(self) -> bool:
        ...
        try:
            # Import LangWatch AgnoInstrumentor
            ...
            if self.config:
                # Configure instrumentor based on provided settings
            ...
            logger.info("🚀 LangWatch AgnoInstrumentor initialized successfully")
            return True
    ...
    def shutdown(self) -> None:
        ...
        """
        if not self._initialized or not self.instrumentor:
            return
            
        try:
            # Uninstrument if method exists
            if hasattr(self.instrumentor, 'uninstrument'):
