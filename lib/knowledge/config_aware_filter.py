...
class ConfigAwareFilter:
    ...
    def detect_business_unit_from_text(self, text: str) -> Optional[str]:
        """
        ...
        logger.debug("Business unit detected", 
                    ...
                    matched_keywords=best_data["matched_keywords"][:5])  # Log first 5 matches
    ...
    def filter_documents_by_business_unit(self, documents: List[Any], 
                                        target_unit: str) -> List[Any]:
        """
    ...
    def get_business_unit_info(self, unit_id: str) -> Optional[Dict[str, Any]]:
