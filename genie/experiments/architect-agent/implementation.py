...
if __name__ == "__main__":
    ...
    print(f"Type: {proposal.component_type}")
    print(f"\nValidation Status: {proposal.validation_status}")
    print(f"\nIntegration Points: {proposal.integration_points}")
    print(f"\nRationale:\n{proposal.rationale}")
    print(f"\nProposed Configuration:\n{proposal.config_yaml}")
    
    # HITL: Human reviews and approves
    print("\n[HUMAN REVIEW REQUIRED]")
    print("Would you like to apply this configuration? (y/n)")
