...
class IssueDetails(BaseModel):
    ...
    business_unit: BusinessUnit = Field(..., description="Relevant business unit")
    ...
    recommended_action: str = Field(..., description="Recommended next steps for human agent")
...
class EscalationProtocol(BaseModel):
    ...
    assigned_team: BusinessUnit = Field(..., description="Team assigned to handle")
...
class ConversationContext(BaseModel):
    ...
    last_interaction: datetime = Field(..., description="Last customer interaction")
